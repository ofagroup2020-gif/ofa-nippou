// js/db.js
// IndexedDB wrapper (1000件超対応) + グローバル公開（Safari/Chrome安定）
...
(() => {
  ...
  // ===== グローバル公開（Safari/Chrome両対応の肝） =====
  window.OFA_DB = {
    OFA_DB_NAME, OFA_DB_VER,
    STORE_PROFILE, STORE_TENKO, STORE_DAILY,
    idbOpen, idbPut, idbGet, idbDelete, idbGetAll,
    normalizeDate, inRange, includesLike,
    searchRecords, searchMonthly,
  };
